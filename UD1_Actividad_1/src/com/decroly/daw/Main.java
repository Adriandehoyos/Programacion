...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("El orden de mayor a menor es: "+ mayor +" > " + menor);
		...
		double mayor1 = Math.max(num1, num2);
		...
		double tres = reader.nextDouble();
		
		double primero = Math.max(uno, dos);
